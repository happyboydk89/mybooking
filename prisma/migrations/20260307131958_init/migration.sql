...
-- CreateEnum
CREATE TYPE "IndustryType" AS ENUM ('HAIR_SALON', 'CLINIC', 'SPA_MASSAGE');
...
-- AddForeignKey
ALTER TABLE "businesses" ADD CONSTRAINT "businesses_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
